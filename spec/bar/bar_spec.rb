...
describe 'Bar' do
  it 'Sets up a basic reference image for bar graph with random numbers' do
    ...
    plot.marker_count = 8
    plot.data( [5, 12, 9, 6, 7], label: :data , color:  :yellow)
  ...
  it 'Fails to match with the reference image' do
    ...
    plot.title = 'Random Bar Numbers'
    plot.marker_count = 8
    plot.data( [5, 12, 9, 6, 6],label: :data )
  ...
  it 'Geometry adjustment test for large numbers' do
    ...
    plot.marker_count = 8
    plot.data( [7025, 1024, 40_257, 933_672, 1_560_496],label: :data )
  ...
  it 'Tests Both Positive and Negative Values' do
    ...
    plot.data( [-1, 0, 4, -4],label: :apples)
    plot.data( [10, 8, 6, 3], label: :peaches)
  ...
  it 'Test Min Max Ranges' do
    ...
    plot.data( [1, 2, 3, 4],label: :apples)
    plot.data( [4, 3, 2, 1],label: :peaches)
  ...
  it 'Test Legend Overlap' do
    ...
    plot.title = 'My Graph'
    plot.data( [1, 2, 3, 4, 4, 3],label:  'Apples oranges Watermelon')
    plot.data( [4, 8, 7, 9, 8, 9],label: :Oranges)
    plot.data( [2, 3, 1, 5, 6, 8],label: :Watermelon)
