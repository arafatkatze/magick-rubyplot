...
module Rubyplot
  class Figure
    ...
    def scatter! *args, &block
      ...
      if @backend == :default || @backend == :GR
        ...
        @active_subplotGR.tasks.push(
          Rubyplot::Scripting::Plotsb::Scatter.new(x_coordinates, y_coordinates,
  ...
  def with_backend plot, *args
    case Rubyplot.backend
    when :magick
      Rubyplot::plot.new args
    when :gr
      Rubyplot::GR::plot.new args
    end
  end
end
